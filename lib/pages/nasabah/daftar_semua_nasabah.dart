...
class _DaftarNasabahState extends State<DaftarNasabah> {
  ...
  Future _getAllData() async {
    ...
    try {
      var url = Uri.parse(
          'https://frontliner.intermediatech.id/api/home/all_assignment?marketing_id=' +
  ...
  Future _postDataJson() async {
    ...
    marketing_id = prefs.getInt('idUser');
    try {
      var url = Uri.parse('https://frontliner.intermediatech.id/api/marketing/search_by_new_customer_and_name');
